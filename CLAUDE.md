...
- **Not needed on this kernel/board**: `ipu3-imgu-iommu`, `accelerometer-orientation`, `backlight-permissions`, `tablet-mode-switch`, `audio-avs-dsp`, `waydroid-netfilter`. (`ec-buttons-poll` is **applied** as of 2026-09-05.)
